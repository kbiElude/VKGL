                                               ...
                                               const GLint* params)
{
    ...
    VKGL_TRACE("glTexParameterIiv(target=[%s] pname=[%s] params=[%p])",
...
static void vkglTexParameterIiv_execute(OpenGL::Context* in_context_ptr,
                                        const GLenum&    in_target,
                                        const GLenum&    in_pname,
                                        const GLint*     in_params_ptr)
{
...
void OpenGL::vkglTexParameterIiv_with_validation(OpenGL::Context* in_context_ptr,
                                                 const GLenum&    in_target,
                                                 const GLenum&    in_pname,
                                                 const GLint*     in_params_ptr)
{
