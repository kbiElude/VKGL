                                           ...
                                           const GLuint* value)
{
    ...
    VKGL_TRACE("glUniform2uiv(location=[%d] count=[%d] value=[%p])",
               location,
...
static void vkglUniform2uiv_execute(OpenGL::Context* in_context_ptr,
                                    const GLint&     in_location,
                                    const GLsizei&   in_count,
                                    const GLuint*    in_value_ptr)
{
...
void OpenGL::vkglUniform2uiv_with_validation(OpenGL::Context* in_context_ptr,
                                             const GLint&     in_location,
                                             const GLsizei&   in_count,
                                             const GLuint*    in_value_ptr)
{
