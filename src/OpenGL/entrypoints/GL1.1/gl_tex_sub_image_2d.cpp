                                             ...
                                             const void* pixels)
{
    ...
    VKGL_TRACE("glTexSubImage2D(target=[%s] level=[%d] xoffset=[%d] yoffset=[%d] width=[%d] height=[%d] format=[%s] type=[%s] pixels=[%p])",
...
static void vkglTexSubImage2D_execute(OpenGL::Context* in_context_ptr,
                                      const GLenum&    in_target,
                                      const GLint&     in_level,
                                      const GLint&     in_xoffset,
                                      const GLint&     in_yoffset,
...
void OpenGL::vkglTexSubImage2D_with_validation(OpenGL::Context* in_context_ptr,
                                               const GLenum&    in_target,
                                               const GLint&     in_level,
                                               const GLint&     in_xoffset,
                                               const GLint&     in_yoffset,
