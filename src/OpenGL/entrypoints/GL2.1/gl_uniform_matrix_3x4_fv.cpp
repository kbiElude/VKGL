...
static void vkglUniformMatrix3x4fv_execute(VKGL::Context*   in_context_ptr,
                                           const GLint&     in_location,
                                           const GLsizei&   in_count,
                                           const GLboolean& in_transpose,
                                           const GLfloat*   in_value_ptr)
...
void OpenGL::vkglUniformMatrix3x4fv_with_validation(VKGL::Context*   in_context_ptr,
                                                    const GLint&     in_location,
                                                    const GLsizei&   in_count,
                                                    const GLboolean& in_transpose,
                                                    const GLfloat*   in_value_ptr)
{
    if (validate(in_context_ptr,
                 ...
                 in_value_ptr) )
    {
        vkglUniformMatrix3x4fv_execute(in_context_ptr,
                                       in_location,
                                       in_count,
                                       in_transpose,
                                       in_value_ptr);
