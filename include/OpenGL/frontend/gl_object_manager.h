...
namespace OpenGL
{
    ...
    public:
        ...
        virtual ReferenceUniquePtr get_default_object_reference()                    const = 0;
    ...
    public:
        ...
        ReferenceUniquePtr acquire_always_latest_snapshot_reference (const GLuint& in_id);
        ReferenceUniquePtr acquire_current_latest_snapshot_reference(const GLuint& in_id);
    ...
    protected:
        ...
        ReferenceUniquePtr get_default_object_reference()                    const final;
        ...
        ReferenceUniquePtr        acquire_reference            (const GLuint&             in_id,
        ...
        ReferenceUniquePtr m_default_object_reference_ptr;
